...
public class EnderecoController {
    ...
    public ResponseEntity<EnderecoDTO> insert(@PathVariable Long id,@RequestBody EnderecoDTO dto) {
    ...
    public ResponseEntity<List<EnderecoDTO>> findEnderecoByIdAluno(@PathVariable Long id){
        List<EnderecoDTO> dto = service.getEnderecosbyAlunoId(id);
        return ResponseEntity.ok().body(dto);
    }
}
